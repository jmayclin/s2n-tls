 ...
 * No DHE (would require extra setup with s2n_config_add_dhparams)
 */
struct s2n_cipher_suite *cipher_suites_20250416[] = {
    /* TLS1.2 with ECDSA */
    &s2n_ecdhe_ecdsa_with_aes_128_gcm_sha256,
    &s2n_ecdhe_ecdsa_with_aes_256_gcm_sha384,
...
const struct s2n_cipher_preferences cipher_preferences_20250416 = {
    .count = s2n_array_len(cipher_suites_20250416),
    .suites = cipher_suites_20250416,
    .allow_chacha20_boosting = false,
};
