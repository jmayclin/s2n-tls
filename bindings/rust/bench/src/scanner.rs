...
pub const FIPS_ALLOWED_GROUPS: [params::KxGroup; 8] = [
    KxGroup::P_256,
    KxGroup::P_384,
    KxGroup::P_521,
    KxGroup::ffdhe2048,
...
pub const FIPS_ALLOWED_CIPHERS: [params::Cipher; 30] = [
    ...
    Cipher::Legacy(LegacyCipher::TLS_ECDHE_ECDSA_WITH_AES_128_CCM),
    Cipher::Legacy(LegacyCipher::TLS_ECDHE_ECDSA_WITH_AES_256_CCM),
    Cipher::Legacy(LegacyCipher::TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8),
    Cipher::Legacy(LegacyCipher::TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8),
    ...
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_128_GCM_SHA256),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_256_GCM_SHA384),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_128_CCM),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_256_CCM),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_128_CCM_8),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_256_CCM_8),
    ...
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_256_CBC_SHA256),
    Cipher::Legacy(LegacyCipher::TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA),
    Cipher::Legacy(LegacyCipher::TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_128_CBC_SHA),
    Cipher::Legacy(LegacyCipher::TLS_DHE_RSA_WITH_AES_256_CBC_SHA),
    // 3.3.1.2 - Cipher Suites for TLS 1.3
    Cipher::Tls13(Tls13Cipher::TLS_AES_128_GCM_SHA256),
    Cipher::Tls13(Tls13Cipher::TLS_AES_256_GCM_SHA384),
    Cipher::Tls13(Tls13Cipher::TLS_AES_128_CCM_SHA256),
    Cipher::Tls13(Tls13Cipher::TLS_AES_128_CCM_8_SHA256),
];

pub const FIPS_RSA_COMPAT_CIPHERS: [params::Cipher; 10] = [
    // Nist SP 800-52 Rev.2 - Appendix D.1
    ...
    Cipher::Legacy(LegacyCipher::TLS_RSA_WITH_AES_128_CCM),
    Cipher::Legacy(LegacyCipher::TLS_RSA_WITH_AES_256_CCM),
    Cipher::Legacy(LegacyCipher::TLS_RSA_WITH_AES_128_CCM_8),
    Cipher::Legacy(LegacyCipher::TLS_RSA_WITH_AES_256_CCM_8),
    ...
    Cipher::Legacy(LegacyCipher::TLS_RSA_WITH_AES_256_CBC_SHA256),
