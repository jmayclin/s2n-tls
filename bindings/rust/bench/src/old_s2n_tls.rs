...
impl SessionTicketCallback for crate::s2n_tls::SessionTicketStorage {
    fn on_session_ticket(
        &self,
        _connection: &mut old_s2n_tls::connection::Connection,
        session_ticket: &old_s2n_tls::callbacks::SessionTicket,
    ) {
...
pub struct S2NConfig {
    mode: Mode,
    config: old_s2n_tls::config::Config,
    pub ticket_storage: crate::s2n_tls::SessionTicketStorage,
}
...
impl crate::harness::TlsBenchConfig for S2NConfig {
    fn make_config(
        ...
        let session_ticket_storage = crate::s2n_tls::SessionTicketStorage::default();
...
impl TlsConnection for S2NConnection {
    ...
    fn new_from_config(
        ...
        let mode = match config.mode {
            Mode::Client => old_s2n_tls::enums::Mode::Client,
            Mode::Server => old_s2n_tls::enums::Mode::Server,
        };
