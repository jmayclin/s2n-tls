...
#[doc = " @deprecated No longer used. See `s2n_rand_set_callbacks`."]
...
pub mod s2n_verify_after_sign {
    #[doc = " Toggles whether generated signatures are verified before being sent."]
    pub type Type = ::libc::c_uint;
...
pub mod s2n_serialization_version {
    #[doc = " Indicates which serialized connection version will be provided. The default value is\n S2N_SERIALIZED_CONN_NONE, which indicates the feature is off."]
    pub type Type = ::libc::c_uint;
