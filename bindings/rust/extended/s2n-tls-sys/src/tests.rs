...
#[test]
fn s2n_client_hello_get_random () {
    let ptr = crate::s2n_client_hello_get_random as *const ();
    assert!(!ptr.is_null());
}
...
#[test]
fn s2n_config_disable_x509_intent_verification () {
    let ptr = crate::s2n_config_disable_x509_intent_verification as *const ();
    assert!(!ptr.is_null());
}
...
#[test]
fn s2n_connection_get_mode () {
    let ptr = crate::s2n_connection_get_mode as *const ();
    assert!(!ptr.is_null());
}
...
#[test]
fn s2n_connection_get_signature_scheme () {
    let ptr = crate::s2n_connection_get_signature_scheme as *const ();
    assert!(!ptr.is_null());
}
...
#[test]
#[cfg(feature = "unstable-allow_ip_in_cn")]
fn s2n_config_allow_ip_in_cn () {
    let ptr = crate::s2n_config_allow_ip_in_cn as *const ();
    assert!(!ptr.is_null());
}

#[test]
#[cfg(feature = "unstable-async_offload")]
fn s2n_async_offload_op_perform () {
    let ptr = crate::s2n_async_offload_op_perform as *const ();
    assert!(!ptr.is_null());
}

#[test]
#[cfg(feature = "unstable-async_offload")]
fn s2n_config_set_async_offload_callback () {
    let ptr = crate::s2n_config_set_async_offload_callback as *const ();
    assert!(!ptr.is_null());
}
...
fn s2n_config_set_handshake_event () {
    let ptr = crate::s2n_config_set_handshake_event as *const ();
    assert!(!ptr.is_null());
}

#[test]
#[cfg(feature = "unstable-events")]
fn s2n_config_set_subscriber () {
    let ptr = crate::s2n_config_set_subscriber as *const ();
    assert!(!ptr.is_null());
}
