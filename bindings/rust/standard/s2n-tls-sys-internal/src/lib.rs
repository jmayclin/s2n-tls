//! This crate provides automatically generated bindings to specific internal
//! C structs and functions from the s2n-tls C library.
//!
//! These bindings are specifically for the s2n-metrics-subscriber crate to replace
//! handwritten bindings in static_lists.rs.

// let the rust compiler that we do need this linked
...
use crate::bindings::s2n_signature_scheme;
